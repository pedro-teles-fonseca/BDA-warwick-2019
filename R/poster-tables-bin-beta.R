...
latex(unname(poster.bin.beta[, c(1:10 ) ]), file = "tables/bin-beta-part1.tex", rowlabel = "Digit")
latex(unname(poster.bin.beta[, c(11:20 ) ]), file = "tables/bin-beta-part2.tex", rowlabel = "Digit")
latex(unname(poster.bin.beta[, c(21:25 ) ]), file = "tables/bin-beta-part3.tex", rowlabel = "Digit")
